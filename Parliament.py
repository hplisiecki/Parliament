...
"""
    Firs initialize some useful functions
...
class Parliament:
    def __init__(self,path):
        ...
        self.digits = re.compile('[0-9][0-9][0-9]')     # Useful
        self.digitu = re.compile('[0-9][0-9]')          # constants
        self.digit = re.compile('[0-9]')                # intiialized here for more clarity later
        try:
    ...
    def convert_pdf_to_html(self):
        ...
        """
        rsrcmgr = PDFResourceManager()          # Magic
        retstr = BytesIO()
        codec = 'utf-8'
        laparams = LAParams()
    ...
    def load(self):
        ...
        # Opens all the pdf files present on the governmental website
    ...
    def save(self,object,title,dir):
        ...
        dir = subdirectory; usually one of these: pis / ko / left / psl / konfederacja / mn / repository
    ...
    def set(self):
        ...
        self.left = members elected from the elective lists of "Lewica"
        ...
        with open(self.path + 'parliament/repository/left.pkl', 'rb') as f:
    ...
    def sort(self):
        ...
        for i in first:                                   # Sorts the elements of each of the month lists
            del i[0]                                      #     according to theorder of the days on which they were
    ...
    def party(self, name):
        ...
        self.name = name of the party (pis / ko / psl / left / konfederacja / mn / rest)
        ...
        for i in tqdm(party):                               # Searches for the statements made by each of the
            ...
            self.finder = i
            self.rostrum()                                  # Ignores the members who did not speak at all
            if len(self.orationes)>0:
                ordered = self.sort()
    ...
    def orator(self):
        ...
        if self.finder in self.left:
            rue = self.path + 'parliament/left/' + self.finder[0] + '.pkl'
